                            ...
                            <div class="row">
                                ...
                                <form  action="" method="post" id="payment_form">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        ...
                                        @if(Auth::guard('profile')->guest())
                                            <div class="form-group">
                                                <label for="shippingFull_name">Nama Lengkap <span>*</span></label>
                                                <input type="text" class="form-control" name="name" value="" placeholder="Full Name" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">No Telepon <span>*</span></label>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="shipping-details-area">
                                        ...
                                        <div class="form-group">
                                            <label for="shipingPhone_number">Nomer Telepon <span>*</span></label>
