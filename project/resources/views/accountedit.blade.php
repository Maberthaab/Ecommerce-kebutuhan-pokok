                        ...
                        <div id="account-information-tab">
                            ...
                            <div class="edit-account-info-div">
                                ...
                                <form action="{{ action('UserProfileController@update',['id' => $user->id]) }}" method="POST">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label for="dash_email">Alamat <span>*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label for="dash_email">Kota <span>*</span></label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 form-group">
                                            <label for="dash_email">Kode Pos <span>*</span></label>
