                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="POST" action="{!! action('ProductController@destroy',['id' => $product->id]) !!}">
                                        ...
                                        @if($product->status==1)
                                            <a href="{!! url('admin/products') !!}/status/{{$product->id}}/0" class="btn btn-warning btn-xs"><i class="fa fa-times"></i> Deactive </a>
                                        @else
                                            <a href="{!! url('admin/products') !!}/status/{{$product->id}}/1" class="btn btn-primary btn-xs"><i class="fa fa-times"></i> Active </a>
                                        @endif
