                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('ProductController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Masukkan Gambar Product <span class="required"></span>
                                </label>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                   <img style="max-width: 250px;" src="" id="adminimg" alt="No gambar produk yang diadd">
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
...
<div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number"> Gambar Produk Gallery <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group" id="pSizes" style="display: none;">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input class="form-control col-md-7 col-xs-12" name="sizes" value="50kg,25kg,20kg,15kg,10kg,5kg,2kg,1kg,800gr,500gr,250gr," data-role="tagsinput"/>
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Product Deskripsi<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Harga Baru<span class="required"></span>
                                    <p class="small-label"></p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Harga Lama<span class="required"></span>
                                    <p class="small-label"></p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Stok Product<span class="required">*</span>
                                    <p class="small-label"></p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Pengembalian Barang<span class="required"></span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
