                    ...
                    <div class="product-header-content">
                        ...
                        <div class="line-entry">
                          ...
                          <!--<div class="header-top-entry increase-icon-responsive login">
                            ...
                            <a href="{{url('/cart')}}" class="header-top-entry open-cart-popup" id="notify"><div class="title"><i class="fa fa-shopping-cart"></i><span>{{$language->my_cart}}</span> <b id="carttotal">{{$settings[0]->currency_sign}}000</b></div></a>
    ...
    @yield('content')
        ...
        <div class="cart-box popup">
            <div class="popup-container">
                ...
                <div class="summary">
                    <div class="grandtotal">{{$language->total}} <span id="grandttl">{{$settings[0]->currency_sign}}000</span></div>
                </div>
