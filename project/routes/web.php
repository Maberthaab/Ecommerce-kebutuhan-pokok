...
Route::get('/orderreport', 'FrontEndController@orderreport');
...
Route::post('/user/forgot', 'Auth\ProfileResetPassController@resetPass')->name(
	'user.forgotpass.submit');
...
Route::post('/orderreport', 'FrontEndController@order')->name('orderreport.submit');





    Route::get('/report', 'ReportController@index')->name('report.submit');
    Route::get('/report/pdf/{invoice}', 'ReportController@invoicePdf')->name('report.pdf');
    Route::get('/report/excel/{invoice}', 'ReportController@invoiceExcel')->name('report.excel');
